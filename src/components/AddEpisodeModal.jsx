...
const getAttributes = (trajectoryId) => {
  ...
  return groupsData.filter((group) =>
    trajectory.nestedGroups.includes(group.id)
  );
};
...
function AddEpisodeModal({ onClose }) {
  ...
  const [attributes, setAttributes] = useState(
    getAttributes(selectedTrajectoryId)
  );
    ...
    <dialog id="episode_modal">
      ...
      <form onSubmit={handleFormSubmit}>
        ...
        <div className={styles["radio-container"]}>
          <label>
            <span className="secondary-button">Episode</span>
            <input
              type="radio"
              name="type"
              id="episode"
          ...
          <label>
            <span className="secondary-button">Evenement</span>
            <input
              type="radio"
              name="type"
              id="event"
